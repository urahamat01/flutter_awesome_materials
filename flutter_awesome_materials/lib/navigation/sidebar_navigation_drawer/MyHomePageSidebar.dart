...
class MyHomePageSidebar extends StatefulWidget {
  @override
  _MyHomePageSidebarState createState() => _MyHomePageSidebarState();
}

class _MyHomePageSidebarState extends State<MyHomePageSidebar> {
